...
//    grades.forEach((k,v) -> System.out.println(k + " achieved by: " + v));
        ...
        school.stream().collect(Collectors.groupingBy(Student::getLetterGrade, Collectors.mapping(student -> student.name.trim(), Collectors.joining(", ")))).forEach((k, v) -> System.out.println(v + " achieved grade " + k));
    }
}
